<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Module_Employees/EmployeeMaster.master" CodeBehind="ApproveEmployee.aspx.cs" Inherits="ShriKartikeya.Portal.ApproveEmployee" %>
                            ...
                            <div id="tabs-2">
                                <asp:UpdatePanel runat="server" ID="UpRef">
                                    <ContentTemplate>
                                        ...
                                        <asp:Panel ID="pnlphysical2" Enabled="false" runat="server" GroupingText="<strong>&nbsp;Physical Standards &nbsp;</strong>" Style="margin-top: 10px">
                                        ...
                                        <asp:Panel ID="pnlphysical1" runat="server" Enabled="false" GroupingText="<strong>&nbsp;Address Details&nbsp;</strong>" Style="margin-top: 10px">
