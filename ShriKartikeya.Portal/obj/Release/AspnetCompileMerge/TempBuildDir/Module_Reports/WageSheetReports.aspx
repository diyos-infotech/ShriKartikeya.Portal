                                    ...
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name">
                                             ...
                                             <asp:TemplateField HeaderText="PD" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Basic+VDA" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCdbasic1" runat="server" Text='<%#Eval("Cdbasic", "{0:0}") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalCdBasic"></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="HRA" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCdhra1" runat="server" Text='<%#Bind("Cdhra","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalCdHRA"></asp:Label>
                                                </FooterTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="ALL" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcdSpecialAllowance1" runat="server" Text='<%#Bind("CdSpecialAllW","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalcdSpecialAllowance"></asp:Label>
                                                </FooterTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Gross Total" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTempGross1" runat="server" Text='<%#Math.Round(Convert.ToDouble(Eval("TempGross"))) %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lbltotalTempGross"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 17--%>
                                            <asp:TemplateField HeaderText="Month-Year" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 18--%>
                                            <asp:TemplateField HeaderText="Sal. Rate" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblsalTempGross" runat="server" Text='<%# Eval("TempGross") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lbltotalTempGross"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 19--%>
                                            <asp:TemplateField HeaderText="Fixed Basic" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCdFixedbasic" runat="server" Text='<%#Eval("Cdbasic", "{0:0}") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalCdBasic"></asp:Label>
                                            ...
                                            <%-- 20--%>
                                            <asp:TemplateField HeaderText="Fixed DA" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 21--%>
                                            <asp:TemplateField HeaderText="Fixed HRA" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFixedCdhra" runat="server" Text='<%#Bind("Cdhra","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalCdHRA"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 22--%>
                                            <asp:TemplateField HeaderText="Fixed CCA" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 23--%>
                                            <asp:TemplateField HeaderText="Fixed Conv" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 24--%>
                                            <asp:TemplateField HeaderText="Fixed W.A." ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 25--%>
                                            <asp:TemplateField HeaderText="Fixed Nfhs" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 26--%>
                                            <asp:TemplateField HeaderText="Fixed RC" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 27--%>
                                            <asp:TemplateField HeaderText="Fixed CS" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 28--%>
                                            <asp:TemplateField HeaderText="Fixed Addl Amount" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 29--%>
                                            <asp:TemplateField HeaderText="Fixed Food Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 30--%>
                                            <asp:TemplateField HeaderText="Fixed WO Amt" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 31--%>
                                            <asp:TemplateField HeaderText="Fixed NHs Amt" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 32--%>
                                            <asp:TemplateField HeaderText="Fixed Medical Re-imbursement" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 33--%>
                                            <asp:TemplateField HeaderText="Fixed Special AllW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcdCenterSpecialAllowance" runat="server" Text='<%#Bind("CdSpecialAllW","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalcdSpecialAllowance"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 34--%>
                                            <asp:TemplateField HeaderText="Fixed Travel Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 35--%>
                                            <asp:TemplateField HeaderText="Fixed Mobile Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 36--%>
                                            <asp:TemplateField HeaderText="Fixed Performance Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 37--%>
                                            <asp:TemplateField HeaderText="Fixed L.W" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 38--%>
                                            <asp:TemplateField HeaderText="Fixed NPOTs Amt" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 39--%>
                                            <asp:TemplateField HeaderText="Fixed Incentivs" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 40--%>
                                            <asp:TemplateField HeaderText="Fixed Bonus" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 41--%>
                                            <asp:TemplateField HeaderText="Fixed Gratuity" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 42--%>
                                            <asp:TemplateField HeaderText="Fixed O.A." ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 43--%>
                                            <asp:TemplateField HeaderText="Fixed OT Rate" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRatecdOTAmt" runat="server" Text='<%#Bind("CdOtAmt1","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalcdOTAmount"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 44--%>
                                            <asp:TemplateField HeaderText="Fixed Service Weightage" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 45--%>
                                            <asp:TemplateField HeaderText="Fixed Rank Allowance" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 46--%>
                                            <asp:TemplateField HeaderText="Fixed Att Bonus" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 47--%>
                                            <asp:TemplateField HeaderText="Fixed Night Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 48--%>
                                            <asp:TemplateField HeaderText="fixed ADDL4HR" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 49--%>
                                            <asp:TemplateField HeaderText="fixed QTRALLOW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 50--%>
                                            <asp:TemplateField HeaderText="fixed RELALLOW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 51--%>
                                            <asp:TemplateField HeaderText="fixed SITEALLOW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 52--%>
                                            <asp:TemplateField HeaderText="fixed GunAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 53--%>
                                            <asp:TemplateField HeaderText="fixed FireAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 54--%>
                                            <asp:TemplateField HeaderText="fixed TelephoneAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 55--%>
                                            <asp:TemplateField HeaderText="fixed Reimbursement" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 56--%>
                                            <asp:TemplateField HeaderText="fixed HardshipAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 57--%>
                                            <asp:TemplateField HeaderText="fixed PaidHolidayAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 58--%>
                                            <asp:TemplateField HeaderText="Duties" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDutiesdutyhrs" runat="server" Text='<%#Bind("NoOfDuties") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalDuties"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 59--%>
                                            <asp:TemplateField HeaderText="OT's" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOTsCenter" runat="server" Text='<%#Bind("OTs") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalOts"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 62--%>
                                            <asp:TemplateField HeaderText="PL Days" ItemStyle-Width="2%" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 63--%>
                                            <asp:TemplateField HeaderText="Basic+DA" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 72--%>
                                            <asp:TemplateField HeaderText="Addl Amount" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 73--%>
                                            <asp:TemplateField HeaderText="Food Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 76--%>
                                            <asp:TemplateField HeaderText="Medical Re-imbursement" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 77--%>
                                            <asp:TemplateField HeaderText="Special AllW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 78--%>
                                            <asp:TemplateField HeaderText="Travel Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 79--%>
                                            <asp:TemplateField HeaderText="Mobile Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 80--%>
                                            <asp:TemplateField HeaderText="Performance Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 81--%>
                                            <asp:TemplateField HeaderText="Adv L.W" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Incentivs" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenterIncentivs" runat="server" Text='<%#Bind("Incentivs","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalIncentivs"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 88--%>
                                            <asp:TemplateField HeaderText="Service Weightage" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 89--%>
                                            <asp:TemplateField HeaderText="Arrears" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenterArrears" runat="server" Text='<%#Bind("Arrears","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalArrears"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 90--%>
                                            <asp:TemplateField HeaderText="Att Bonus" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 91--%>
                                            <asp:TemplateField HeaderText="Night Allw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 92--%>
                                            <asp:TemplateField HeaderText="ADDL4HR" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 93--%>
                                            <asp:TemplateField HeaderText="QTRALLOW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 94--%>
                                            <asp:TemplateField HeaderText="RELALLOW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 95--%>
                                            <asp:TemplateField HeaderText="SITEALLOW" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 96--%>
                                            <asp:TemplateField HeaderText="GunAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 97--%>
                                            <asp:TemplateField HeaderText="FireAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 98--%>
                                            <asp:TemplateField HeaderText="TelephoneAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 99--%>
                                            <asp:TemplateField HeaderText="Reimbursement" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 100--%>
                                            <asp:TemplateField HeaderText="HardshipAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 101--%>
                                            <asp:TemplateField HeaderText="PaidHolidayAllw" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 102--%>
                                            <asp:TemplateField HeaderText="Rank Allowance" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 103--%>
                                            <asp:TemplateField HeaderText="Gross" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 104--%>
                                            <asp:TemplateField HeaderText="PF" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenterPF" runat="server" Text='<%#Bind("PF","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalPF"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 105--%>
                                            <asp:TemplateField HeaderText="ESI" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenterESI" runat="server" Text='<%#Bind("ESI","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalESI"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 106--%>
                                            <asp:TemplateField HeaderText="ProfTax" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenterProfTax" runat="server" Text='<%#Bind("ProfTax","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalProfTax"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 107--%> 
                                            <asp:TemplateField HeaderText="Sal.Adv" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 111--%>
                                            <asp:TemplateField HeaderText="Others" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 115--%>
                                            <asp:TemplateField HeaderText="Gen Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 116--%>
                                            <asp:TemplateField HeaderText="LWF" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 117--%>
                                            <asp:TemplateField HeaderText="Advance" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenterPenalty" runat="server" Text='<%#Bind("Penalty","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: justify">
                                                        <asp:Label runat="server" ID="lblTotalPenalty"></asp:Label>
                                            ...
                                            <%-- 118--%>
                                            <asp:TemplateField HeaderText="ATM Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Medical Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 120--%>
                                            <asp:TemplateField HeaderText="MLWF Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 121--%>
                                            <asp:TemplateField HeaderText="Food Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 122--%>
                                            <asp:TemplateField HeaderText="IDCard Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 123--%>
                                            <asp:TemplateField HeaderText="Rent Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 125--%>
                                            <asp:TemplateField HeaderText="PVC Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 126--%>
                                            <asp:TemplateField HeaderText="License Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 127--%>
                                            <asp:TemplateField HeaderText="Adv4 Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 128--%>
                                            <asp:TemplateField HeaderText="TDS Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNightTDSRoundDed" runat="server" Text='<%#Bind("Extra","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: justify">
                                                        <asp:Label runat="server" ID="lblTotalNightRoundDed"></asp:Label>
                                            ...
                                            <%-- 129--%>
                                            <asp:TemplateField HeaderText="ManpowerMob Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 130--%>
                                            <asp:TemplateField HeaderText="Mobileusage Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 131--%>
                                            <asp:TemplateField HeaderText="MediClaim Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 132--%>
                                            <asp:TemplateField HeaderText="Crisis Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 133--%>
                                            <asp:TemplateField HeaderText="Telephone Bill Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 134--%>
                                            <asp:TemplateField HeaderText="Admin Charges Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 135--%>
                                            <asp:TemplateField HeaderText="Registration Fee" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 136--%>
                                            <asp:TemplateField HeaderText="Total Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotalDeductions" runat="server" Text='<%#Bind("TotalDeductions","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalDeductions"></asp:Label>
                                                </FooterTemplate>
                                            ...
                                            <%-- 137--%>
                                            <asp:TemplateField HeaderText="Advance Against Bonus" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <%-- 138--%>
                                            <asp:TemplateField HeaderText="Net Amt" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCenternetamount" runat="server" Text='<%#Bind("ActualAmount","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalNetAmount"></asp:Label>
                                                </FooterTemplate>
