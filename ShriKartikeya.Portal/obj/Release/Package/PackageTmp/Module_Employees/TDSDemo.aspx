<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Employees/EmployeeMaster.master" AutoEventWireup="true" CodeBehind="TDSDemo.aspx.cs" Inherits="ShriKartikeya.Portal.TDSDemo" %>
...
<asp:Content ID="RightOne" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $("#<%=ddlplaceofstay.ClientID %>").change(function () {
            alert($("#<%=ddlplaceofstay.ClientID %>").val());
        });
