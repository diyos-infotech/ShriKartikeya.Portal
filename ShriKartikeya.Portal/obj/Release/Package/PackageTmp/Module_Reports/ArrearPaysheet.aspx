<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="ArrearPaysheet.aspx.cs" Inherits="ShriKartikeya.Portal.ArrearPaysheet" %>
                    ...
                    <div class="dashboard_center">
                        <div class="sidebox">
                            ...
                            <div class="boxbody" style="padding: 5px 5px 5px 5px;">
                              ...
                              <div id="forExport" runat="server" class="rounded_corners" style="overflow: scroll">
                                        <asp:GridView ID="GVListEmployees" runat="server" ShowFooter="true" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Performance Allw" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProfAllw" runat="server" Text='<%#Bind("PerformanceAllw","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Arrears" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                 ...
                                                 <%-- 32--%>
                                                 <asp:TemplateField HeaderText="Food Allw" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblFoodAllw" runat="server" Text='<%#Bind("FoodAllw","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                 ...
                                                 <%-- 33--%>
                                                 <asp:TemplateField HeaderText="Medical Allw" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMedicalAllw" runat="server" Text='<%#Bind("MedicalAllw","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                 ...
                                                 <%-- 34--%>
                                                  <asp:TemplateField HeaderText="Travel Allw" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                 ...
                                                 <%-- 35--%>
                                                <asp:TemplateField HeaderText="Mobile Allw" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMobileAllw" runat="server" Text='<%#Bind("MobileAllw","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                 ...
                                                 <%-- 36--%>
                                                <asp:TemplateField HeaderText="Night Allw" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                 ...
                                                 <%-- 37--%>
                                                 <asp:TemplateField HeaderText="Service Weightage" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblServiceWeightage" runat="server" Text='<%#Bind("ServiceWeightage","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label runat="server" ID="lblTotalSeviceWeightage"></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                 
                                                 <%-- 38--%>
                                                 <asp:TemplateField HeaderText="Incentivs" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                 ...
                                                 <%-- 39--%>
                                                 <asp:TemplateField HeaderText="PL Amount" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPLAmount" runat="server" Text='<%#Bind("PLAmount","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <%-- 40--%>
                                                <asp:TemplateField HeaderText="WO Amount" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblWOAmount" runat="server" Text='<%#Bind("WOAmount","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                  ...
                                                  <%-- 41--%>
                                                <asp:TemplateField HeaderText="Npots Amount" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblNpotsAmount" runat="server" Text='<%#Bind("Npotsamt","{0:0}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Total Earnings" ItemStyle-HorizontalAlign="Right" Visible="false" >
                                                    <ItemTemplate>
