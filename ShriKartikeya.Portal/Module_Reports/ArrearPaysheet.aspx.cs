...
{
    public partial class ArrearPaysheet : System.Web.UI.Page
    {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        if (actAmount != 0)
                        {
                            ...
                            string strPLAmt = dt.Rows[i]["PLAmount"].ToString();
                            if (strPLAmt.Trim().Length != 0)
                            {
                                totalPLAmount += Convert.ToSingle(strPLAmt);
                            }
                            ...
                            if (strServiceWeightage.Trim().Length != 0)
                            {
                    ...
                    lblTotalProfAllw.Text = Math.Round(totalPerformanceAllw).ToString();
                    ...
                    Label lblTotalFoodAllw = GVListEmployees.FooterRow.FindControl("lblTotalFoodAllw") as Label;
                    ...
                    Label lblTotalMedicalAllw = GVListEmployees.FooterRow.FindControl("lblTotalMedicalAllw") as Label;
                    ...
                    Label lblTotalMobileAllw = GVListEmployees.FooterRow.FindControl("lblTotalMobileAllw") as Label;
                    ...
                    Label lblTotalSeviceWeightage = GVListEmployees.FooterRow.FindControl("lblTotalSeviceWeightage") as Label;
                    lblTotalSeviceWeightage.Text = Math.Round(totalServiceWeightage).ToString();
                    ...
                    Label lblTotalPLAmount = GVListEmployees.FooterRow.FindControl("lblTotalPLAmount") as Label;
